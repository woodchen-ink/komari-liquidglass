...
const Node = React.memo(({ basic, live, online }: NodeProps) => {
  ...
  if (!online) {
    return (
      <div
        id={basic.uuid}
        className="liquid-glass node-card rounded-xl border border-red-300/40 cursor-pointer transition-all w-full"
      >
        <div className="p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3 mb-2">
            <span className="h-3 w-3 shrink-0 rounded-full bg-red-500 shadow-sm pulse-animation shadow-red-300 dark:shadow-red-900" />
  ...
  return (
    <div
      id={basic.uuid}
      className="liquid-glass node-card rounded-xl cursor-pointer transition-all w-full"
    >
      <div className="p-4 relative">
        ...
        <div className="flex items-center justify-between mb-3 gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0">
            {basic.group && (
              <div
                className="px-2 py-0.5 text-[10px] sm:text-xs font-medium rounded-full shrink-0"
                style={{
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          ...
          <div className="bg-muted/60 backdrop-blur-sm rounded-md p-2 border border-border">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs sm:text-sm font-medium">Traffic</span>
              </div>
          ...
          <div className="bg-muted/60 backdrop-blur-sm rounded-md p-2 border border-border">
            <div className="flex items-center mb-2">
              ...
              <span className="text-xs sm:text-sm font-medium">Conn</span>
            </div>
            <div className="grid grid-cols-3 gap-1 text-xs sm:text-sm font-semibold">
